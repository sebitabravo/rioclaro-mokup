							...
							>
								<div className='flex items-center justify-between mb-6'>
									<div>
										<h2
											id='metrics-heading'
											className='text-2xl font-bold text-gov-black mb-2'
										>
											Métricas del Sistema
										</h2>
										<p className='text-gov-gray-a'>
											Resumen en tiempo real del estado de las estaciones de
											monitoreo
										</p>
									</div>
								</div>
							...
							<div className='grid grid-cols-1 xl:grid-cols-5 gap-8'>
								...
								>
									<div className='mb-6'>
										<h2
											id='map-heading'
											className='text-xl font-bold text-gov-black mb-2'
										>
											Ubicación de Estaciones
										</h2>
										<p className='text-sm text-gov-gray-a'>
											Visualización geográfica de las estaciones de monitoreo
											activas
										</p>
									</div>
							...
							<section className='mt-12 bg-gov-white rounded-lg border border-gov-accent shadow-sm p-6'>
								<div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6'>
									<div className='flex items-start space-x-3'>
										...
										<div>
											<h3 className='font-semibold text-gov-black mb-1'>
												Actualizaciones Automáticas
											</h3>
											<p className='text-sm text-gov-gray-a'>
												Los datos se actualizan cada 5 minutos para mantener
									...
									<div className='flex items-start space-x-3'>
										<div className='w-10 h-10 rounded-full bg-gov-green/10 flex items-center justify-center flex-shrink-0'>
											<svg
												className='w-5 h-5 text-gov-green'
												fill='none'
												stroke='currentColor'
												viewBox='0 0 24 24'
											>
										...
										<div>
											...
											<p className='text-sm text-gov-gray-a'>
												Sistema de sensores calibrados con precisión para
												garantizar mediciones exactas del nivel del agua.
											</p>
										</div>
									</div>
									...
									<div className='flex items-start space-x-3'>
										<div className='w-10 h-10 rounded-full bg-gov-orange/10 flex items-center justify-center flex-shrink-0'>
											<svg
												className='w-5 h-5 text-gov-orange'
												fill='none'
												stroke='currentColor'
												viewBox='0 0 24 24'
											>
												<path
													...
													strokeLinejoin='round'
													strokeWidth={2}
													d='M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-2.5L13.732 4c-.77-.833-1.964-.833-2.734 0L3.732 16.5C2.962 18.333 3.924 20 5.464 20z'
												/>
											</svg>
										</div>
										<div>
											...
											<p className='text-sm text-gov-gray-a'>
												Notificaciones automáticas cuando los niveles superan
